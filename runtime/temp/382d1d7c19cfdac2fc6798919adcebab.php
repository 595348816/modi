<?php /*a:1:{s:77:"/Users/zhangxupeng/item/Think.Admin/application/wechat/view/review/index.html";i:1537284939;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title></title>
        ...
        <link rel="stylesheet" href="/static/plugs/aui/aui.css">
    </head>
        ...
        <section class="aui-chat">
            ...
            <div class="aui-chat-item aui-chat-left">
                <div class="aui-chat-media">
                    <img style="border-radius:50%;border:1px solid #ccc;min-width:42px;display:inline-block;" src="/static/theme/img/headimg.png"/>
                </div>
                <div class="aui-chat-inner">
                    ...
                    <div class="aui-chat-content bg-white">
                        <div class="aui-chat-arrow one"></div>
                        <div class="aui-chat-arrow two"></div>
                        <img src='<?php echo htmlentities((isset($content) && ($content !== '')?$content:"/static/theme/img/image.png")); ?>'/>
                    </div>
            ...
            <div class="aui-chat-item">
                <div class="aui-chat-content" style='background: #fff;border:1px solid #ccc;width:100%;max-width:100%;padding:0'>
                    <section class="aui-content">
                        ...
                        <div data-href="<?php echo url('wechat/review/index'); ?>?content=<?php echo htmlentities($vo['id']); ?>&type=article" class="aui-card-list" style="cursor:pointer;margin:0;padding:.5rem .5rem .3rem .5rem;display:block;background:none">
                        ...
                        <?php else: ?>
                        <table data-href="<?php echo url('wechat/review/index'); ?>?content=<?php echo htmlentities($vo['id']); ?>&type=article" class="aui-border-t" style='cursor:pointer;width:100%;margin:0;padding:.3rem .5rem .5rem .5rem;'>
                            <tr style='width:100%;padding:0;margin:0;'>
                                <td style="text-overflow:ellipsis;overflow:hidden;display:inline-block;"><?php echo htmlentities($vo['title']); ?></td>
                        ...
                        <div class="aui-card-list-content-padded aui-border-t" style="padding-top:.3rem">
                            <a class="aui-list-item-arrow" style="color:#333;font-size:.6rem;display:block" href="<?php echo url('wechat/review/index'); ?>?content=<?php echo htmlentities($vo['id']); ?>&type=article">阅读全文</a>
                        </div>
